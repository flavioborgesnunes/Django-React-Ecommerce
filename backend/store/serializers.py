...
class ProductSerializer(serializers.ModelSerializer):
    gallery = GalerySerializer(many=True, read_only=True)
    ...
    class Meta:
        model = Product
        fields = ['id', 'title', 'image', 'description', 'category', 'price',
                  'old_price', 'shipping_amount', 'stock_qty', 'in_stock',
                  'status', 'featured', 'views', 'rating', 'vendor', 'gallery',
                  'color', 'specification',  'product_rating', 'rating_count',
                  'size', 'pid', 'slug', 'date',
                  ]
